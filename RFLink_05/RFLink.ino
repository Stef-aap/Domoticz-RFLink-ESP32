...
// LEARNING_MODE
//    0 : Production Mode
//    1 : after a series detection, every protocol that fits is displayed
//    2 : after a series detection, the length and code is displayed
...
//                        ValidCommand=2;
//                     }
ValidCommand = 1 ;   // <<< TIJDELIJK OM BOVENSTAANDE TE COMPENSEREN
