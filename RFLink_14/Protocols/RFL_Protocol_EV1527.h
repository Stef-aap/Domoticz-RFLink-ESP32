...
//        if ( (  P1 < RawSignal.Min ) || ( P1 > RawSignal.Max ) ) return false;   // first pulse too short or too long
//        if ( (  P2 < RawSignal.Min ) || ( P2 > RawSignal.Max ) ) return false;   // second pulse too short or too long
